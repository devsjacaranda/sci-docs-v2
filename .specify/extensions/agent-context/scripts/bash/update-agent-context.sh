...
PROJECT_ROOT="$(pwd)"
CIV2_DOCS_DIR="civ2-docs"
EXT_CONFIG="$PROJECT_ROOT/$CIV2_DOCS_DIR/.specify/extensions/agent-context/agent-context-config.yml"
...
specs = Path(sys.argv[1]) / "civ2-docs" / "specs"
plans = sorted(
    specs.glob("*/plan.md"),
